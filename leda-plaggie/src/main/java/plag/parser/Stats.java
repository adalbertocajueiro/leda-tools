...
public class Stats implements Serializable {
	...
	public static Stats getInstance() {
		// teve que iniciar novamente porque da erro ao rodar duas vezes
		// instance = new Stats();
		return instance;
	}
	...
	public static void newCounter(String name) throws StatsException {
		// if (instance.counters.get(name) != null) {
		// throw new StatsException("Stat "+name+" already defined.");
		// }
		//se counter ja foi definido entao zera
	...
	public static void setCounterLimit(String name, int limit) throws StatsException {
		if (instance.counters.get(name) == null) {
	...
	public static int getCounterLimit(String name) throws StatsException {
	...
	public static void incCounter(String name) throws StatsException {
		if (instance.counters.get(name) == null) {
			throw new StatsException("Stat " + name + " does not exist.");
		} else
	...
	public static int getCounter(String name) throws StatsException {
		if (instance.counters.get(name) == null) {
			throw new StatsException("Stat " + name + " does not exist.");
		} else
	...
	public static void newDistribution(String name) throws StatsException {
	...
	public static List getDistribution(String name) throws StatsException {
		if (instance.distributions.get(name) == null) {
	...
	public static double getDistributionMax(String name) throws StatsException {
		if (instance.distributions.get(name) == null) {
			throw new StatsException("Distribution " + name + " does not exist.");
		} else {
	...
	public static double getDistributionMin(String name) throws StatsException {
		if (instance.distributions.get(name) == null) {
			throw new StatsException("Distribution " + name + " does not exist.");
		} else {
			List dist = (ArrayList) instance.distributions.get(name);
	...
	public static void addToDistribution(String name, double value) throws StatsException {
		if (instance.distributions.get(name) == null) {
			throw new StatsException("Distribution " + name + " does not exist.");
		} else {
	...
	public static double getDistributionAverage(String name) throws StatsException {
		if (instance.distributions.get(name) == null) {
			throw new StatsException("Distribution " + name + " does not exist.");
		} else {
			ArrayList list = (ArrayList) instance.distributions.get(name);
	...
	public static void printHtmlDistribution(PrintStream out, String name, double lowVal, double highVal, double step,
			boolean usePercentage, char displayChar, int maxChars) throws StatsException {
		if (instance.distributions.get(name) == null) {
			throw new StatsException("Distribution " + name + " does not exist.");
		} else {
			List dist = (ArrayList) instance.distributions.get(name);
	...
	public static void printDistribution(PrintStream out, String name, double lowVal, double highVal, double step,
			char displayChar, int maxChars) throws StatsException {
		if (instance.distributions.get(name) == null) {
			throw new StatsException("Distribution " + name + " does not exist.");
		} else {
			List dist = (ArrayList) instance.distributions.get(name);
