...
/**
 * A class that represents a pair (fileName,folder) where fileName is a file name
 * and folder is the folder where the file will be extracted.
 * @author Adalberto
 *
 */
public class FileFolder {
	...
	public boolean equals(Object obj) {
		...
		if(obj instanceof FileFolder){
			...
			result = pureFileName.equalsIgnoreCase(((FileFolder) obj).getFileName());
			int i = 0;
		}
		return result;
	}
