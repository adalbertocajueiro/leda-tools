	...
	public static void main(String[] args) throws IOException {
        ...
        try {
        	...
        	/*if(loaded instanceof List){
        		for (Element item : (List<Element>)loaded) {
        	...
        	fu.insertElement(doc, parent);
        	fu.writeXMLFile(doc,xmlFilePath);*/
            ...
            for (int i = 0; i < listElement.size(); i++) {
                ...
                System.out.println("Department : " + node.getChildText("department"));
                System.out.println("Salary : " + node.getChildText("salary"));
                System.out.println("Address : " + node.getChildText("address"));
            }
            */
