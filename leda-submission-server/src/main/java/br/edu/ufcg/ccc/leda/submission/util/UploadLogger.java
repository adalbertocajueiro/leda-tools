...
public class UploadLogger {
	...
	public static String logSubmission(File submitted, UploadConfiguration config, String studentName) throws IOException{
		...
		String content = "File " + submitted.getName() + " was received. It was sent by " + studentName; 
